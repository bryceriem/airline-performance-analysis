...
For a full account of what was prompted, what changed, and what was modified or rejected at each phase, see [gen-ai-use-statement.md](documentation/gen-ai-use-statement.md).
<br>
